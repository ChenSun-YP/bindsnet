...
network.add_connection(
    connection=forward_connection, source="B", target="C"
)
...
network.add_monitor(monitor=target_monitor2, name="C")
...
spikes = {
    "A": source_monitor.get("s"), "B": target_monitor.get("s"),"C": target_monitor2.get("s")
}
